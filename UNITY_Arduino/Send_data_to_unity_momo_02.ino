...
Mauricio:
cet programme marche avec script09.cs
*/
...
//  Serial.println();
  ...
  if (Serial2.available()>0){
    ...
    SensorLine5_answer = digitalRead(SensorLine5_pin);
        ...
        if (continuer==1)
        {
        Serial2.print("sa:");   Serial2.print  (SensorLine1_answer);  Serial2.print  (";");
        Serial2.print("sb:");   Serial2.print  (SensorLine2_answer);  Serial2.print  (";"); 
        Serial2.print("sc:");   Serial2.print  (SensorLine3_answer);  Serial2.print  (";");
        Serial2.print("sd:");   Serial2.print  (SensorLine4_answer);  Serial2.print  (";");
        Serial2.print("se:");   Serial2.print  (SensorLine5_answer);  Serial2.print  (";");

        Serial2.print("ga:");   Serial2.print  (m.magnetic.x);        Serial2.print  (";");
        Serial2.print("gb:");   Serial2.print  (m.magnetic.y);        Serial2.print  (";");
        Serial2.print("gc:");   Serial2.print  (m.magnetic.z);        Serial2.print  (";");
        Serial2.print("z");                                           Serial2.println(";");

        Serial.print("sa:");   Serial.print  (SensorLine1_answer);  Serial.print  (";");
        Serial.print("sb:");   Serial.print  (SensorLine2_answer);  Serial.print  (";"); 
        Serial.print("sc:");   Serial.print  (SensorLine3_answer);  Serial.print  (";");
        Serial.print("sd:");   Serial.print  (SensorLine4_answer);  Serial.print  (";");
        Serial.print("se:");   Serial.print  (SensorLine5_answer);  Serial.print  (";");

        Serial.print("ga:");   Serial.print  (m.magnetic.x);        Serial.print  (";");
        Serial.print("gb:");   Serial.print  (m.magnetic.y);        Serial.print  (";");
        Serial.print("gc:");   Serial.print  (m.magnetic.z);        Serial.print  (";");
        Serial.print("z");                                          Serial.println(";");
        continuer=0;
      }
